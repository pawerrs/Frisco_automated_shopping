...
namespace Frisco_automated_shopping.Extensions
{
    public static class LoginExtension
    {
        ...
        {
            driver.WaitUntilVisible(By.XPath("//*[@id='wrapper']/div[9]/div/div/a[2]/img")).Click();
        ...
        public static IWebDriver EnterEmailAndAddress(this IWebDriver driver, string email, string password)
        {
            ...
            driver.WaitUntilVisible(By.XPath("/ html / body / div[1] / div / div[2] / div / div[2] / div / form / div / div[1] / div / input")).SendKeys(email);
            driver.WaitUntilVisible(By.XPath("//*[@id='loginPassword']")).SendKeys(password);
            return driver;
        }
